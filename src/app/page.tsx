...
export default function Main() {
  ...
  return <main className="flex flex-col realtive">
    {videoPreview && <div className='fixed z-[999] video-preview w-full h-full bg-black p-20' onClick={() => setVideoPreview(false)}>
      ...
      <iframe allowFullScreen className='w-full h-full' src="https://www.youtube.com" title="EvaluateAI | AI-Powered Answer Sheet Evaluator | SaaS Platform | Envato Codecanyon | Full Demo" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
    </div>}
